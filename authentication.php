<?php	
	...
	*/
	...
	$restricted_pages[ 'Admin' ]['access'] = [ "admin-page", "dashboard", "consumers", "billing", "updatestat", "add-consumer", "edit-consumer", "consumption", "data", "bill-print", "bill-generate", "reports"];
